...
Per PRD §6-7, this is the final success criteria - the blog must be live and accessible.
  ...
  <steps>
    ...
    <step order="3">Deploy using wrangler: CLOUDFLARE_API_TOKEN=cfat_yVizuscq4XqHStwiGFwcl5ACexOUM83ZU93YIJiP67b278df CLOUDFLARE_ACCOUNT_ID=a02352ad1742197c106c1774fcbada2d npx wrangler pages deploy out --project-name=shipyard-ai</step>
