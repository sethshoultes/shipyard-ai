 ...
 */
import { promises as fs, existsSync, renameSync, rmSync, cpSync, } from 'fs';
 ...
 */
export async function removeTempDir(tempPath) {
    try {
 ...
 */
export function backupDirectory(sourcePath, backupPath) {
 ...
 */
export function replaceDirectory(sourcePath, targetPath) {
 ...
 */
export async function checkCriticalFiles(srcPath) {
    try {
