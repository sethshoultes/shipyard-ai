...
Build a tiny self-contained TypeScript module — a slug-utility library — inside `deliverables/build-model-canary/`.

## Required files

All under `/home/agent/shipyard-ai/deliverables/build-model-canary/`:
