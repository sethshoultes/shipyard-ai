...
const projects = [
  ...
  },
  {
    ...
    vertical: "Yoga & Wellness",
    location: "Portland, OR",
    template: "Marketing",
    url: "https://yoga.shipyard.company",
    screenshot: "/screenshots/sunrise-yoga.png",
    description:
    ...
    color: "from-emerald-900/30 to-green-900/10",
    accent: "text-emerald-400",
    badge: "bg-emerald-500/10 text-emerald-400 border-emerald-500/20",
    previewBg: "bg-gradient-to-br from-emerald-950 via-green-950 to-teal-950",
  },
  {
    name: "Poster",
    vertical: "Developer Tool",
    location: "Built in one session",
    template: "Cloudflare Worker",
    url: "https://www.shipyard.company/poster/sethshoultes/shipyard-ai",
    screenshot: "/poster/sethshoultes/shipyard-ai",
    description:
    ...
    previewBg: "bg-gradient-to-br from-indigo-950 via-violet-950 to-slate-950",
  },
];
      ...
      <section className="border-b border-border bg-surface/50">
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-6 px-6 py-10 sm:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted">Sites + 1 tool</p>
          </div>
          <div>
            <p className="text-3xl font-bold">3</p>
            <p className="text-sm text-muted">Stacks (EmDash, Workers, R2)</p>
          </div>
          <div>
            <p className="text-3xl font-bold">&lt;2h</p>
            <p className="text-sm text-muted">Avg autonomous pipeline</p>
          </div>
        </div>
      </section>
